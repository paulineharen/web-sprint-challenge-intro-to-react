...
It is an open-source JS library that is used to build UI. React solves the issue with changing data without the page reloading--just the components affected.

1. Describe component state.

An object that reacts to changes automatically.

1. Describe props.

A vessel to pass information between components.

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?

Side effects are anything (other than the calculation) that is changed once a calculation or process has finished up and can be observed.
